...
function Contact() {
    ...
    return (
        <div id="contact" className='lg:my-20 pb-20'>

            <div className='mb-20 p-12 w-full bg-gradient-to-r from-transparent from-45% to-amber-900
            ...
            <div className='flex flex-wrap justify-evenly text-xl font-light text-slate-500 tracking-tight w-full gap-2 pt-10'>
                <motion.p 
            ...
            <motion.div 
             ...
             className="py-6 pt-8 flex justify-center items-center">
                {/* Form container */}
